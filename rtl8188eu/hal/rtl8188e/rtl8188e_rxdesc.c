	...
	struct recv_stat *prxstat)
{
	...
	if (pattrib->pkt_rpt_type == NORMAL_RX) { /* Normal rx packet	 */
		...
		pattrib->macid_vld = (u8)((report.rxdw1 >> 12) & 0x1); /* used to check unencrypted data frame*/
		pattrib->swdec = (report.rxdw0 & BIT(27)) ? 1 : 0; /* used to check unencrypted data frame*/
