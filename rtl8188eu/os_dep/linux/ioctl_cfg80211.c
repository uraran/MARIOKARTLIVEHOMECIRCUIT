				...
				struct cfg80211_connect_params *sme)
{
	...
	struct rtw_wdev_priv *pwdev_priv = adapter_wdev_data(padapter);
	_irqL irqL;
	u8  wpa2_ie[34] = {0x30,0x14,0x01,0x00,0x00,0x0F,0xAC,0x04,0x01,0x00,
					   0x00,0x0F,0xAC,0x04,0x01,0x00,0x00,0x0F,0xAC,0x02,
					   0x00,0x00,0x7F,0x04,0x00,0x00,0x0A,0x02,0x3B,0x04,
					   0x51,0x51,0x53,0x54};
	...
	if(padapter->Encrypt_en) {
		...
		sme->crypto.ciphers_pairwise[0] = 0xfac04;
		sme->crypto.cipher_group = 0xfac04;
		sme->ie_len = 34; 
	}
	...
	if(padapter->Encrypt_en)
		ret = rtw_cfg80211_set_wpa_ie(padapter, wpa2_ie, sme->ie_len);
	else
