...
/*	Initialize EncryptEnable setting 	*/
	padapter->Encrypt_en = _FALSE;
	_rtw_memset(padapter->EncryptKey, 0, sizeof(padapter->EncryptKey));
...
static int __init rtw_drv_entry(void)
{
	...
	printk(KERN_INFO "[BootTime_LoadWlanDriver] %ld.%09ld\n", currentTimeSpec.tv_sec, currentTimeSpec.tv_nsec);
