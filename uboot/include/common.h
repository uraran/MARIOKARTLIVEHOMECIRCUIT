...
/* RTK 2nd stage bootloader support */
#ifdef CONFIG_SECOND_BOOTCODE_SUPPORT
  #if defined(CONFIG_GOLDENBOOT_SUPPORT)
	#include <goldenboot.h>
	#define is_1st_bootcode is_golden_boot()
  #else
	#define is_1st_bootcode 1
  #endif
#else
  #define is_1st_bootcode 0
#endif
