/*
 * Configuration settings for the Realtek 1095 demo llama board.
 *
 * Won't include this file.
 * Just type "make <board_name>_config" and will be included in source tree.
 */

#ifndef __CONFIG_RTK_RTD1095_DEMO_LLAMA_H
#define __CONFIG_RTK_RTD1095_DEMO_LLAMA_H
...
/*
 * The followings were RTD1095 demo llama specific configuration settings.
 */

/* Board config name */
#define CONFIG_BOARD_DEMO_RTD1095

#define CONFIG_BOARD_FPGA_RTD1195_EMMC //emmc driver.
...
#define CONFIG_SYS_RTK_EMMC_FLASH
	...
	*   uboot/examples/flash_writer_u/$(CONFIG_FLASH_WRITER_SETTING).inc */
	#define CONFIG_FLASH_WRITER_SETTING            "1095_common"
...
#endif /* __CONFIG_RTK_RTD1095_DEMO_LLAMA_H */
