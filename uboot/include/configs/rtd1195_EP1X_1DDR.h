...
#include <configs/rtd1195_customized_feature.h>
...
/* Board config name */
#define CONFIG_BOARD_EP1X_RTD1195
...
#define CONFIG_SYS_RTK_NAND_FLASH
	...
	*  uboot/examples/flash_writer_u/$(CONFIG_FLASH_WRITER_SETTING).inc */	
	#define CONFIG_FLASH_WRITER_SETTING            "1195_force_nand_EP1X_1DDR"
	...
	#define CONFIG_SYS_RTK_DUALIMAGE
