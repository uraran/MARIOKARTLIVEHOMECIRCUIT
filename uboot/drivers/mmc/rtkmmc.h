...
#define EMMC_MAX_XFER_BLKCNT 512
...
#define CLOCK_DIV_256           	(0x00000003<<6)
#define CLOCK_DIV_128           	(0x00000002<<6)
...
#ifdef FORCE_CHIP_REVB
#define GET_CHIP_REV()  (PHOENIX_REV_B)
#else
...
EXTERN_CALL int mmccr_Stream_Cmd( unsigned int xferCmdCode, struct rtk_cmd_info * cmd_info, unsigned int bIgnore );
#endif /* end of file */
