...
//#define REG_NF_BASE_ADDR				(0x18010000)  //NWC
#define REG_NF_BASE_ADDR				(0x1802f000)  //SWC
...
#define REG_NF_NWC_BASE_ADDR				(0x18010000)

#define CP_NF_SET		(REG_NF_NWC_BASE_ADDR + 0x50a4)

#define CP_NF_INI_KEY_0	(REG_NF_NWC_BASE_ADDR + 0x5094)
#define CP_NF_INI_KEY_1	(REG_NF_NWC_BASE_ADDR + 0x5098)
#define CP_NF_INI_KEY_2	(REG_NF_NWC_BASE_ADDR + 0x509c)
#define CP_NF_INI_KEY_3	(REG_NF_NWC_BASE_ADDR + 0x50a0)

#define CP_NF_KEY_0		(REG_NF_NWC_BASE_ADDR + 0x5084)
#define CP_NF_KEY_1		(REG_NF_NWC_BASE_ADDR + 0x5088)
#define CP_NF_KEY_2		(REG_NF_NWC_BASE_ADDR + 0x508c)
#define CP_NF_KEY_3		(REG_NF_NWC_BASE_ADDR + 0x5090)
