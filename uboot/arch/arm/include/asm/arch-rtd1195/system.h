...
#define POWER_SAVING 							(0x18070000 + 0x1200)  			// power saving config for fw.
...
#define UBOOT_SECURE_MCP_MEMORY_ADDR			(0x06000000)	// 0x06000000~0x062fffff (3M)
#define UBOOT_SECURE_MCP_MEMORY_SIZE			(0x00300000)	// 3M
