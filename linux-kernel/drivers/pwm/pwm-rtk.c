...
{
	return container_of(chip, struct rtd1195_pwm_chip, chip);
}

#define to_pwm_device(d) return container_of(d, struct rtd1195_pwm_chip, chip);

int set_real_freq_by_target_freq(struct rtd1195_pwm_chip *pc, int hwpwm, int target_freq) {
...
int set_real_period_by_target_period(struct rtd1195_pwm_chip *pc, int hwpwm, int target_period_ns) {
...
int set_real_freq_by_target_div(struct rtd1195_pwm_chip *pc, int hwpwm, int clksrc_div, int clkout_div) {
	int base_freq = pc->base_freq;
	int real_freq, div;
...
int set_clk_duty(struct rtd1195_pwm_chip *pc, int hwpwm, int duty_rate) {
...
static void pwm_set_register(struct rtd1195_pwm_chip *pc, int hwpwm)
{
	u32 value;
	int clkout_div = 0;
	int clk_duty = 0;
...
static int rtd1195_pwm_config(struct pwm_chip *chip, struct pwm_device *pwm,
...
static int rtd1195_pwm_enable(struct pwm_chip *chip, struct pwm_device *pwm)
{
	struct rtd1195_pwm_chip *pc = to_rtd1195_pwm_chip(chip);
...
static void rtd1195_pwm_disable(struct pwm_chip *chip, struct pwm_device *pwm)
{
	struct rtd1195_pwm_chip *pc = to_rtd1195_pwm_chip(chip);
...
static const struct pwm_ops rtd1195_pwm_ops = {
	.config = rtd1195_pwm_config,
	.enable = rtd1195_pwm_enable,
	.disable = rtd1195_pwm_disable,
	.owner = THIS_MODULE,
};
...
static ssize_t pwm_show_dutyRate(struct device *dev, struct device_attribute *attr, char *buf, int hwpwm)
{
	...
	struct rtd1195_pwm_chip *pc = platform_get_drvdata(pdev);
...
static int rtd1195_pwm_remove(struct platform_device *pdev)
{
	struct rtd1195_pwm_chip *pc = platform_get_drvdata(pdev);
	int i;
...
static struct platform_driver rtd1195_pwm_platform_driver = {
	.driver = {
		.name		= "pwm",
		.owner		= THIS_MODULE,
		.of_match_table = of_match_ptr(rtd1195_pwm_of_match),
	},
	.probe = rtd1195_pwm_probe,
	.remove = rtd1195_pwm_remove,
};
module_platform_driver(rtd1195_pwm_platform_driver);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("REALTEK Corporation");
MODULE_ALIAS("platform:rtd1195-pwm");
