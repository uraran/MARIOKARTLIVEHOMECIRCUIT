...
//#define SND_CACHE_ADDRESS(x)        ((void *)(0x80000000 | (((unsigned int) (x)) & 0x1FFFFFFF)))
//#define SND_UNCACHE_ADDRESS(x)      ((void *)(0xA0000000 | (((unsigned int) (x)) & 0x1FFFFFFF)))
...
#define RTK_DMP_INFO    (SNDRV_PCM_INFO_MMAP | \
...
#define RTK_DMP_FORMATS (SNDRV_PCM_FMTBIT_S8 | SNDRV_PCM_FMTBIT_S16_LE | SNDRV_PCM_FMTBIT_S24_LE)

#define RTK_DMP_RATES   (SNDRV_PCM_RATE_5512 | SNDRV_PCM_RATE_8000 | SNDRV_PCM_RATE_11025 | \
...
#define RTK_DMP_RATE_MIN                5512
#define RTK_DMP_RATE_MAX                192000
#define RTK_DMP_CHANNELS_MIN            1
#define RTK_DMP_CHANNELS_MAX            2
#define RTK_DMP_MAX_BUFFER_SIZE         (32*1024)//(16*1024)
#define RTK_DMP_MIN_PERIOD_SIZE         64
#define RTK_DMP_MAX_PERIOD_SIZE         (8*1024)
#define RTK_DMP_PERIODS_MIN             4
#define RTK_DMP_PERIODS_MAX             1024
#define RTK_DMP_FIFO_SIZE               32
...
typedef struct snd_card_RTK_pcm {
    ...
    ******************************************************************************************************************/
    ...
    unsigned long nPeriodBytes;
    unsigned long nRingSize;            // bytes
#ifdef USE_ION_AUDIO_HEAP
...
typedef struct snd_card_RTK_capture_pcm {
    ...
    int bInitRing;
    int bStop;
    unsigned int *pAIRingData[8];
    unsigned int *pLPCMData;
    unsigned int nPeriodJiffies;
    unsigned long nPeriodBytes;
    unsigned long nFrameBytes;
    unsigned long nRingSize; // bytes
    unsigned long nLPCMRingSize;
#ifdef USE_ION_AUDIO_HEAP
