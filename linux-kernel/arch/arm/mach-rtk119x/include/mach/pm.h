...
#define SUSPEND_MAGIC_CLRMASK                   (~(0xFF << SUSPEND_MAGIC_SHIFFT))
...
#define SUSPEND_WATCHDOG_EN_SHIFFT              23
#define SUSPEND_WATCHDOG_EN_BITS                1
#define SUSPEND_WATCHDOG_EN_MASK(val)           SET_VAL(val, SUSPEND_WATCHDOG_EN_BITS, SUSPEND_WATCHDOG_EN_SHIFFT)
#define SUSPEND_WATCHDOG_EN_GET(reg)            GET_VAL(reg, SUSPEND_WATCHDOG_EN_BITS, SUSPEND_WATCHDOG_EN_SHIFFT)

#define SUSPEND_WATCHDOG_ENR_SHIFFT             22
#define SUSPEND_WATCHDOG_ENR_BITS               1
#define SUSPEND_WATCHDOG_ENR_MASK(val)          SET_VAL(val, SUSPEND_WATCHDOG_ENR_BITS, SUSPEND_WATCHDOG_ENR_SHIFFT)
#define SUSPEND_WATCHDOG_ENR_GET(reg)           GET_VAL(reg, SUSPEND_WATCHDOG_ENR_BITS, SUSPEND_WATCHDOG_ENR_SHIFFT)

#define SUSPEND_WATCHDOG_TIMER_SHIFFT           0
#define SUSPEND_WATCHDOG_TIMER_BITS             16
#define SUSPEND_WATCHDOG_TIMER_MASK(val)        SET_VAL(val, SUSPEND_WATCHDOG_TIMER_BITS, SUSPEND_WATCHDOG_TIMER_SHIFFT)
#define SUSPEND_WATCHDOG_TIMER_GET(reg)         GET_VAL(reg, SUSPEND_WATCHDOG_TIMER_BITS, SUSPEND_WATCHDOG_TIMER_SHIFFT)
